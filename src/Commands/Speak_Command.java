...
public class Speak_Command implements Command {
    ...
    private String speakMilan(NPC milan) {
        Item filtr = game.getPlayerInventory().getItemById("filtr");
        boolean hasMask = game.getPlayerInventory().getItemById("plynova_maska") != null;
        ...
        game.getPlayerInventory().removeItem(filtr);
        game.getPlayerInventory().hasItem("plynova_maska");
    ...
    private String speakBabicka(NPC babicka) {
        ...
        boolean lektvarInInventory = game.getPlayerInventory().getItemById("uspavaci_lektvar") != null;
        ...
        game.getPlayerInventory().addItem(lektvar);
